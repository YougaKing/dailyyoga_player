        ...
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnPreparedListener(new OnPreparedListener() {
                ...
                public void onPrepared(IMediaPlayer mp, long time) {
                    finalListener.onPrepared(MediaPlayerProxy.this, time);
                }
            });
        } else {
    ...
    public void setOnErrorListener(OnErrorListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnErrorListener(new OnErrorListener() {
                @Override
                public boolean onError(IMediaPlayer mp, int what, int extra, Throwable t) {
                    return finalListener.onError(MediaPlayerProxy.this, what, extra, t);
                }
            });
        } else {
    ...
    public void setOnTimedTextListener(OnTimedTextListener listener) {
        if (listener != null) {
            ...
            mBackEndMediaPlayer.setOnTimedTextListener(new OnTimedTextListener() {
                @Override
                public void onTimedText(IMediaPlayer mp, MediaTimedText text) {
