...
public abstract class AbstractMediaPlayer implements IMediaPlayer {
    ...
    protected final void notifyOnPrepared() {
        if (mOnPreparedListener != null)
            mOnPreparedListener.onPrepared(this, 0);
    }
    ...
    protected final boolean notifyOnError(int what, int extra, Throwable t) {
        return mOnErrorListener != null && mOnErrorListener.onError(this, what, extra, t);
    }
    ...
    protected final void notifyOnTimedText(MediaTimedText text) {
