...
import com.dailyyoga.cn.media.example.application.AppActivity;
import com.dailyyoga.cn.media.example.eventbus.FileExplorerEvents;
import com.dailyyoga.cn.media.example.fragments.FileListFragment;
...
public class FileExplorerActivity extends AppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mSettings == null) {
            mSettings = VideoActivity.pvOptions(this);
        }
